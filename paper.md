...
在所有同义对中，我们首先在第4.4小节中抽取包含3586个唯一实体的25k对样本进行**实体语义相关性评估**。其余160k对进一步分割为80%、10%、10%，用于4.6小节中**同义词预测实验**的训练、验证和测试。同义词对的80%分割也被用作我们的**词汇嵌入训练的术语-术语**知识。在表3中，我们总结了数据集的特征。
...
:right_anger_bubble: 25000对同义词（包括了3586个独立实体）是什么样的？
